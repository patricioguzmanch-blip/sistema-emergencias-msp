...
def formulario_principal():
    ...
    if st.session_state.rol_actual == "USUARIO":
        ...
        with tab2:
            ...
            busqueda_cedula = col_ced_b.text_input("Ingrese la Cédula o Identificación del Ciudadano a corregir:", key="search_edit_local")
    ...
    if st.session_state.rol_actual == "ADMIN":
        ...
        with tab1:
            ...
            cedula_auditoria = col_ced_a.text_input("Ingrese Cédula / Documento del Ciudadano para auditoría general:")
        ...
        with tab2:
            ...
            with subtab_pac:
                ...
                ced_pac_edit = col_pac_b.text_input("Ingrese el Número de Identificación del Paciente a modificar:", key="search_pac_cat")
            ...
            with subtab_med:
                ...
                ced_prof_edit = col_med_b.text_input("Ingrese la Cédula Profesional del Médico/Obstetriz a modificar:", key="search_med_cat")
